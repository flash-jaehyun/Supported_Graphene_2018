...
dir_list = [
    ...
    # NEW
    # N-Graphene
    "/scratch/users/flores12/03_graph_N_Fe/02_orr_ads/N_graph/1-att/__test__/02_relax_bare_slab/spinpol_False/",
    "/scratch/users/flores12/03_graph_N_Fe/02_orr_ads/N_graph/1-att/__test__/02_relax_bare_slab/spinpol_True/",
    ]
